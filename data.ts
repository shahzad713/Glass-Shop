import { 
  Layers, Grid, Shield, Umbrella, Sofa, Building2, Wrench, Hammer, Maximize, 
  Wind, Sun, Lock, Droplets, Lightbulb, Store, AlignJustify, Paintbrush, 
  MoveHorizontal, ShieldCheck, BoxSelect, VolumeX, Sparkles, Factory, Home, 
  Circle, Key
} from 'lucide-react';
...
export const services: ServiceItem[] = [
  ...
  },
  {
    ...
    category: 'Glass & Mirrors',
    description: 'Minimalist patch-fitting glass doors for commercial entryways.',
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1600585154526-990dced4db0d?q=80&w=800&auto=format&fit=crop',
    icon: AlignJustify
  },
  {
    id: 'g9',
    ...
    imageUrl: 'https://images.unsplash.com/photo-1577140917170-285929db55cc?q=80&w=800&auto=format&fit=crop',
    icon: Layers
  },
  {
    id: 'g10',
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1623164214435-654cb25f560e?q=80&w=800&auto=format&fit=crop',
    icon: ShieldCheck
  },
  {
    id: 'a4',
    ...
    imageUrl: 'https://images.unsplash.com/photo-1517581177697-a06a18919da2?q=80&w=800&auto=format&fit=crop',
    icon: AlignJustify
  },
  {
    id: 'a5',
    ...
    imageUrl: 'https://images.unsplash.com/photo-1621509424722-e3a1f73b6038?q=80&w=800&auto=format&fit=crop',
    icon: Key
  },
  {
    id: 'a6',
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1506193796853-48880628e931?q=80&w=800&auto=format&fit=crop',
    icon: Maximize
  },
  {
    id: 'u3',
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1522050212171-61b01dd24579?q=80&w=800&auto=format&fit=crop',
    icon: Home
  },
  {
    id: 'f3',
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1564513294-28b9bd1c4293?q=80&w=800&auto=format&fit=crop',
    icon: Circle
  },
  {
    id: 'f5',
    ...
    imageUrl: 'https://images.unsplash.com/photo-1585822765582-72c67295475e?q=80&w=800&auto=format&fit=crop',
    icon: Droplets
  },
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1596238385623-690a6f8742b6?q=80&w=800&auto=format&fit=crop',
    icon: Sun
  },
  {
    id: 'i5',
  ...
  // Repair
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1632219036727-b54c867b2d5d?q=80&w=800&auto=format&fit=crop',
    icon: Wrench
  },
  {
    id: 'r2',
    ...
    imageUrl: 'https://images.unsplash.com/photo-1589820296156-2454bb8a6d54?q=80&w=800&auto=format&fit=crop',
    icon: Wrench
  },
  {
    id: 'r3',
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1550586678-f7b13d39dbaf?q=80&w=800&auto=format&fit=crop',
    icon: Sparkles
  },
];
...
export const projects: ProjectItem[] = [
  { 
    ...
    fullDescription: 'A modern 1-kanal villa requiring complete exterior glazing. We installed 12mm tempered spider glass for the main facade and soundproof UPVC windows for all bedrooms.',
    client: 'Mr. Usman Tariq',
    date: 'March 2024',
    servicesUsed: ['Spider Glazing', 'UPVC Windows', 'Glass Railings'],
    imageUrl: 'https://images.unsplash.com/photo-1600596542815-60c37c66321e?q=80&w=800&auto=format&fit=crop' 
  },
  { 
    id: 'p2', 
    ...
    fullDescription: 'Designed and installed frameless glass partitions for a software house. Included automated sensor doors for the main entrance and frosted films for meeting rooms.',
  ...
  { 
    ...
    fullDescription: 'Maintenance and panel replacement for the exterior curtain wall system, ensuring safety and restoring the pristine look of the mall.',
    client: 'Nishat Group',
    date: 'December 2023',
  ...
  { 
    ...
    fullDescription: 'Large scale project involving the supply and installation of energy-efficient UPVC sliding windows for a new apartment block.',
    client: 'Army Housing',
    date: 'November 2023',
  ...
  { 
    ...
    fullDescription: 'High-end retail fit-out featuring 12mm clear tempered glass shop front and custom-cut decorative mirrors for the interior.',
  ...
  { 
    ...
    fullDescription: 'Fabrication and installation of a 5000 sq.ft fiberglass shed structure for raw material storage protection against rain and sun.',
    client: 'Packages Ltd',
    date: 'September 2023',
  ...
  { 
    ...
    fullDescription: 'Connecting two academic blocks with a modern steel and glass covered walkway.',
  ...
  { 
    ...
    fullDescription: 'Installation of specialized multi-layered insulated glass units to maintain sub-zero temperatures inside the park.',
    client: 'Winterland Management',
    date: 'July 2023',
    servicesUsed: ['Insulated Glass', 'Thermal Break Aluminum'],
    imageUrl: 'https://images.unsplash.com/photo-1545558014-8692077e9b5c?q=80&w=800&auto=format&fit=crop' 
  },
  { 
    id: 'p9', 
    ...
    fullDescription: 'High-performance acoustic glazing to ensure complete sound isolation for recording studios.',
    client: 'ARY Network',
    date: 'June 2023',
  ...
  { 
    ...
    fullDescription: 'Heavy steel fabrication and toughened glass canopy installation for toll booths.',
    client: 'NHA',
    date: 'May 2023',
  ...
  { 
    ...
    fullDescription: 'Replaced old aluminum windows with modern, energy-efficient UPVC sliding windows.',
  ...
  { 
    ...
    fullDescription: 'Modernization of a commercial plaza face with silver ACP cladding and blue reflective glass.',
  ...
  { 
    ...
    fullDescription: 'Installed wall-to-wall gym mirrors and glass shower enclosures in the changing rooms.',
    client: 'Fazaia Club',
    date: 'February 2023',
  ...
  { 
    ...
    fullDescription: 'Designed a cantilever fiberglass shed for 3 cars matching the house aesthetics.',
    client: 'Mr. Sohail',
    date: 'January 2023',
  ...
  { 
    ...
    fullDescription: 'Premium 12mm tempered glass railings with seamless floor mounting for unobstructed views.',
    client: 'DHA Management',
    date: 'December 2022',
    servicesUsed: ['Glass Railings'],
    imageUrl: 'https://images.unsplash.com/photo-1599309927702-869c9b54c868?q=80&w=800&auto=format&fit=crop' 
  },
  { 
    id: 'p16', 
    ...
    fullDescription: 'Installed hygiene-friendly touchless automatic sliding doors for the main patient entrance.',
  ...
  { 
    ...
    fullDescription: 'Structural glass skylight to cover the central courtyard while allowing natural light.',
    client: 'Mr. Nadeem',
    date: 'October 2022',
  ...
  { 
    ...
    fullDescription: 'Fabrication of a decorative fiberglass dome and aluminum safety grills for windows.',
    client: 'Mosque Committee',
    date: 'September 2022',
    servicesUsed: ['Fiberglass Dome', 'Safety Grills'],
    imageUrl: 'https://images.unsplash.com/photo-1557053503-0c252e5c8093?q=80&w=800&auto=format&fit=crop' 
  },
  { 
    id: 'p19', 
  ...
  { 
    ...
    fullDescription: 'Renovation of an entire floor with powder-coated aluminum partitions.',
    client: 'State Life',
    date: 'July 2022',
    servicesUsed: ['Aluminum Partitions'],
    imageUrl: 'https://images.unsplash.com/photo-1497215842964-222b430dc094?q=80&w=800&auto=format&fit=crop' 
  },
];
...
export const team: TeamMember[] = [
  ...
  { 
    ...
    imageUrl: 'https://images.unsplash.com/photo-1537511446984-935f663eb1f4?q=80&w=800&auto=format&fit=crop' 
  },
  { 
    id: 't3', 
    name: 'Bilal Khan', 
...
export const products: ProductItem[] = [
  { id: 'prod1', name: 'Tempered Glass 12mm', category: 'Glass', specs: '12mm thickness, impact resistant', description: 'High-grade safety glass for partitions and doors.', imageUrl: 'https://images.unsplash.com/photo-1504917595217-d4dc5ebe6122?q=80&w=800&auto=format&fit=crop' },
  { id: 'prod2', name: 'Aluminum Sliding Profile', category: 'Aluminum', specs: 'Series 2000, Powder Coated', description: 'Durable aluminum profiles for window fabrication.', imageUrl: 'https://images.unsplash.com/photo-1600607686527-6fb886090705?q=80&w=800&auto=format&fit=crop' },
  { id: 'prod3', name: 'UPVC Window Frame', category: 'UPVC', specs: 'Double Glazed Ready, White', description: 'Energy efficient frames ensuring thermal insulation.', imageUrl: 'https://images.unsplash.com/photo-1503387762-592deb58ef4e?q=80&w=800&auto=format&fit=crop' },
  { id: 'prod4', name: 'Fiberglass Sheet', category: 'Fiberglass', specs: '2mm - 5mm, UV Protected', description: 'Corrugated and plain sheets for roofing.', imageUrl: 'https://images.unsplash.com/photo-1595846519845-68e298c2edd8?q=80&w=800&auto=format&fit=crop' },
  { id: 'prod5', name: 'Spider Fittings (SS)', category: 'Hardware', specs: '304 Grade Stainless Steel', description: 'Heavy duty fittings for structural glazing.', imageUrl: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?q=80&w=800&auto=format&fit=crop' },
  { id: 'prod6', name: 'Door Closer Machine', category: 'Hardware', specs: 'Hydraulic, Floor Spring', description: 'Smooth operating machines for glass doors.', imageUrl: 'https://images.unsplash.com/photo-1589820296156-2454bb8a6d54?q=80&w=800&auto=format&fit=crop' },
  { id: 'prod7', name: 'Frosted Glass Film', category: 'Decorative', specs: 'Self-adhesive, Patterned', description: 'Privacy films for office partitions.', imageUrl: 'https://images.unsplash.com/photo-1615529182904-14819c35db37?q=80&w=800&auto=format&fit=crop' },
  { id: 'prod8', name: 'Silicon Sealant', category: 'Adhesives', specs: 'Weatherproof, Clear/Black', description: 'Industrial grade sealant for glass waterproofing.', imageUrl: 'https://images.unsplash.com/photo-1632924154823-74b971a07014?q=80&w=800&auto=format&fit=crop' },
];
